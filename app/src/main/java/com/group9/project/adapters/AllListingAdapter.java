...
public class AllListingAdapter extends RecyclerView.Adapter<AllListingAdapter.ViewHolder> {

    private Context context;
    List<Listing> listings;

    public AllListingAdapter(List<Listing> listings) {
        this.listings = listings;
    }

    @NonNull
    @Override
    public AllListingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_all_listings, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllListingAdapter.ViewHolder holder, int position) {
